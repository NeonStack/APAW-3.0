...
<div class="info-tab space-y-3">
	...
	<div class="w-[80%] mx-auto pt-2 pb-1 text-center text-xs text-slate-400">
		<p>AI estimates for preparedness only. Refer to DOST-PAGASA, NDRRMC & local DRRMO for official alerts</p>
		<p class="mt-0.5">
