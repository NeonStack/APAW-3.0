const resources = [
	...
	},
	{
		...
		description:
			'Deep learning framework used for building and training the LSTM flood height regression model.',
		category: 'Core Algorithms & Libraries',
		iconType: 'iconify',
	...
	},
	{
		title: 'Pytz',
		description:
			'Used for accurate timezone conversions in handling date-time data during preprocessing and inference.',
		category: 'Core Algorithms & Libraries',
		iconType: 'iconify',
		icon: 'carbon:earth',
	...
	// Ancillary AI system, not directly used in backend training or inference but related
	{
		...
		description:
			'Referenced as an AI model for parsing external PAGASA cyclone data, not integrated in backend model training or prediction.',
	...
	{
		title: 'Python',
		description: 'Primary language for backend API, data processing, and model development.',
	...
	},
	{
		title: 'SvelteKit',
		description:
			'Framework for building the frontend application that visualizes flood predictions.',
		category: 'Development & Deployment Stack',
		iconType: 'iconify',
		icon: 'devicon:svelte',
	...
	{
		title: 'Leaflet.js',
		description: 'JavaScript library enabling interactive maps within the frontend user interface.',
		category: 'Development & Deployment Stack',
		iconType: 'iconify',
	...
	{
		title: 'Awesome Table',
		description: 'Web application utilized during data collection for organizing location data.',
	...
	// Institution
	{
		...
		description: 'Academic institution providing project support for the capstone.',
